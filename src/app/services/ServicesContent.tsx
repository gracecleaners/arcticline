  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center pt-20">
        ...
        <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-arctic-500/10 rounded-full blur-[120px] animate-float" />
        <div className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-purple-500/10 rounded-full blur-[100px] animate-float-delayed" />
